...
delay(550);
  ...
  /*while(headCountsLeft+1000>encoders.getCountsLeft() && headCountsRight+1000>encoders.getCountsRight()){
    Angle();
    error = heading - angle;
    leftSpeed = 250 - error*6;
    rightSpeed = 250 + error*6;
    motors.setSpeeds(leftSpeed, rightSpeed);
  }
  */
  heading = angle;
  ...
  while(headCountsLeft+1100>encoders.getCountsLeft() && headCountsRight+1100>encoders.getCountsRight()){
    Angle();
    error = heading - angle;
    leftSpeed = 250 - error*6;
    rightSpeed = 250 + error*6;
...
/*
  if (buzzer.isPlaying() == false) {
    ...
    if (linesPlayed < 1) {
      buzzer.play("T120 O4 eeeeeeeeeeeeeeeeeeeeefed+e R a R O5 c R O3 c R O5 dddddc O4 b O5 dccccc O4 ba O5 c O4 bbbbf+ R b R g+ RRR O2 e RRR O4 eeeeeeeeeeeeee eeefed+e R a O5 ce R a R O6 c R O3 c R O6 dc O5 b O6 dc O5 ba O6 c O5 bag+baec O4 a O5 fedc O4 bag+ba RRRRRRRR");
    }
    else if (linesPlayed < 2) {
      buzzer.play("T140 O4 eeeeeeeeeeeeeeeeeeeeefed+e R a R O5 c R O3 c R O5 dddddc O4 b O5 dccccc O4 ba O5 c O4 bbbbf+ R b R g+ RRR O2 e RRR O4 eeeeeeeeeeeeee eeefed+e R a O5 ce R a R O6 c R O3 c R O6 dc O5 b O6 dc O5 ba O6 c O5 bag+baec O4 a O5 fedc O4 bag+ba RRRRRRRR");
    }
    else if (linesPlayed < 3) {
      buzzer.play("T160 O4 eeeeeeeeeeeeeeeeeeeeefed+e R a R O5 c R O3 c R O5 dddddc O4 b O5 dccccc O4 ba O5 c O4 bbbbf+ R b R g+ RRR O2 e RRR O4 eeeeeeeeeeeeee eeefed+e R a O5 ce R a R O6 c R O3 c R O6 dc O5 b O6 dc O5 ba O6 c O5 bag+baec O4 a O5 fedc O4 bag+ba RRRRRRRR");
    }
    else if (linesPlayed < 4) {
      buzzer.play("T180 O4 eeeeeeeeeeeeeeeeeeeeefed+e R a R O5 c R O3 c R O5 dddddc O4 b O5 dccccc O4 ba O5 c O4 bbbbf+ R b R g+ RRR O2 e RRR O4 eeeeeeeeeeeeee eeefed+e R a O5 ce R a R O6 c R O3 c R O6 dc O5 b O6 dc O5 ba O6 c O5 bag+baec O4 a O5 fedc O4 bag+ba RRRRRRRR");
    }
    else if (linesPlayed < 5) {
      buzzer.play("T200 O4 eeeeeeeeeeeeeeeeeeeeefed+e R a R O5 c R O3 c R O5 dddddc O4 b O5 dccccc O4 ba O5 c O4 bbbbf+ R b R g+ RRR O2 e RRR O4 eeeeeeeeeeeeee eeefed+e R a O5 ce R a R O6 c R O3 c R O6 dc O5 b O6 dc O5 ba O6 c O5 bag+baec O4 a O5 fedc O4 bag+ba RRRRRRRR");
    }
    linesPlayed ++;
    if(linesPlayed == 5){
      linesPlayed = 0;
